...
var (
	...
	modgdiplus = Dll{Name: "gdiplus.dll"}

	procGdipCreateBitmapFromFile     = DllProc{Dll: &modgdiplus, Name: "GdipCreateBitmapFromFile"}
	procGdipCreateBitmapFromHBITMAP  = DllProc{Dll: &modgdiplus, Name: "GdipCreateBitmapFromHBITMAP"}
	procGdipCreateHBITMAPFromBitmap  = DllProc{Dll: &modgdiplus, Name: "GdipCreateHBITMAPFromBitmap"}
	procGdipCreateBitmapFromResource = DllProc{Dll: &modgdiplus, Name: "GdipCreateBitmapFromResource"}
	procGdipCreateBitmapFromStream   = DllProc{Dll: &modgdiplus, Name: "GdipCreateBitmapFromStream"}
	procGdipDisposeImage             = DllProc{Dll: &modgdiplus, Name: "GdipDisposeImage"}
	procGdiplusShutdown              = DllProc{Dll: &modgdiplus, Name: "GdiplusShutdown"}
	procGdiplusStartup               = DllProc{Dll: &modgdiplus, Name: "GdiplusStartup"}
)
