...
var (
	moddwmapi = Dll{Name: "dwmapi.dll"}

	procDwmDefWindowProc                 = DllProc{Dll: &moddwmapi, Name: "DwmDefWindowProc"}
	procDwmEnableBlurBehindWindow        = DllProc{Dll: &moddwmapi, Name: "DwmEnableBlurBehindWindow"}
	procDwmEnableMMCSS                   = DllProc{Dll: &moddwmapi, Name: "DwmEnableMMCSS"}
	procDwmExtendFrameIntoClientArea     = DllProc{Dll: &moddwmapi, Name: "DwmExtendFrameIntoClientArea"}
	procDwmFlush                         = DllProc{Dll: &moddwmapi, Name: "DwmFlush"}
	procDwmGetColorizationColor          = DllProc{Dll: &moddwmapi, Name: "DwmGetColorizationColor"}
	procDwmGetCompositionTimingInfo      = DllProc{Dll: &moddwmapi, Name: "DwmGetCompositionTimingInfo"}
	procDwmGetTransportAttributes        = DllProc{Dll: &moddwmapi, Name: "DwmGetTransportAttributes"}
	procDwmGetWindowAttribute            = DllProc{Dll: &moddwmapi, Name: "DwmGetWindowAttribute"}
	procDwmInvalidateIconicBitmaps       = DllProc{Dll: &moddwmapi, Name: "DwmInvalidateIconicBitmaps"}
	procDwmIsCompositionEnabled          = DllProc{Dll: &moddwmapi, Name: "DwmIsCompositionEnabled"}
	procDwmModifyPreviousDxFrameDuration = DllProc{Dll: &moddwmapi, Name: "DwmModifyPreviousDxFrameDuration"}
	procDwmQueryThumbnailSourceSize      = DllProc{Dll: &moddwmapi, Name: "DwmQueryThumbnailSourceSize"}
	procDwmRegisterThumbnail             = DllProc{Dll: &moddwmapi, Name: "DwmRegisterThumbnail"}
	procDwmRenderGesture                 = DllProc{Dll: &moddwmapi, Name: "DwmRenderGesture"}
	procDwmSetDxFrameDuration            = DllProc{Dll: &moddwmapi, Name: "DwmSetDxFrameDuration"}
	procDwmSetIconicLivePreviewBitmap    = DllProc{Dll: &moddwmapi, Name: "DwmSetIconicLivePreviewBitmap"}
	procDwmSetIconicThumbnail            = DllProc{Dll: &moddwmapi, Name: "DwmSetIconicThumbnail"}
	procDwmSetPresentParameters          = DllProc{Dll: &moddwmapi, Name: "DwmSetPresentParameters"}
	procDwmSetWindowAttribute            = DllProc{Dll: &moddwmapi, Name: "DwmSetWindowAttribute"}
	procDwmShowContact                   = DllProc{Dll: &moddwmapi, Name: "DwmShowContact"}
	procDwmTetherContact                 = DllProc{Dll: &moddwmapi, Name: "DwmTetherContact"}
	procDwmTransitionOwnedWindow         = DllProc{Dll: &moddwmapi, Name: "DwmTransitionOwnedWindow"}
	procDwmUnregisterThumbnail           = DllProc{Dll: &moddwmapi, Name: "DwmUnregisterThumbnail"}
	procDwmUpdateThumbnailProperties     = DllProc{Dll: &moddwmapi, Name: "DwmUpdateThumbnailProperties"}
)
