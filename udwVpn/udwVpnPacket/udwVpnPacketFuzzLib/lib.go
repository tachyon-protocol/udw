package udwVpnPacketFuzzLib

import (
	"github.com/tachyon-protocol/udw/udwBytes"
	"github.com/tachyon-protocol/udw/udwTest"
	"github.com/tachyon-protocol/udw/udwVpn/udwVpnPacket"
	"net"
)
...
func Fuzz(data []byte) int {
	...
	ipPacket, errMsg := udwVpnPacket.NewIpv4PacketFromBuf(data1)
	if errMsg != "" {
		return 0
	}
...
func checkPacket1NotCrash(packet udwVpnPacket.IpPacket) {
	if packet.IsTcp() {
		{
